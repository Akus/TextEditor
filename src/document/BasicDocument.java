...
public class BasicDocument extends Document 
{
	...
	public int getNumSyllables()
	{
		...
		for (String word : tokens) {
			SyllableNum += countSyllables(word);
		}
	...
	public static void main(String[] args)
	{
		...
		//my code
		//String myText = "This is a test.  How many???  Senteeeeeeeeeences are here... there should be 5!  Right?";
		//String myText = "sentence, with, lots, of, commas.!  (And some poaren)).  The output is: 7.5.";
		String myText = "This is a test.  How many???  Senteeeeeeeeeences are here... there should be 5!  Right?";
		//my code
		BasicDocument d = new BasicDocument(myText);
		
		//my code
		System.out.println(d.getText());
		System.out.println(d.getTokens("it+"));
		System.out.println(d.getTokens("[a-zA-Z0-9']+"));
		// my code: getNumWords
		System.out.println(d.getTokens("[a-zA-Z0-9']+").size());

		List<String> myWords = new ArrayList<String>();
		myWords = (d.getTokens("[a-zA-Z0-9']+"));
		System.out.println(myWords);
		System.out.println(myWords.size());
		
		//String myWordRegex = "[a-zA-Z0-9']+"; // my regex
		String myWordRegex = "[a-zA-Z]+";		// official regex

		//String mySentenceRegex = "([.!?]+ *)"; // my regex
		String mySentenceRegex = "([^.!?]+)"; // official regex

		
		//System.out.println(d.getTokens("happy"));
		//System.out.println(d.getTokens("[a-zA-Z]+[yY]"));
		System.out.println("There are " + d.getTokens(mySentenceRegex).size() + " sentences.");
		System.out.println("There are " + d.getTokens(myWordRegex).size() + " words.");
