...
public class EfficientDocument extends Document {
	...
	private void processText()
	{
		...
		// counting sentences excluding punctuation marks from tokens
		...
		for (String item : tokens) {
			...
			if (isWord(item)) {
				...
				numWords ++;
				numSyllables += countSyllables(item);
			}
		...
		// check the last item of tokens. If it's a word instead of punctuation add 1 to numSentences
		// to prevent situations like this:
		// "Time to get weeeeeeeeeeeird, with, the. Punctuation"
