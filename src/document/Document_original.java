...
public abstract class Document_original {
	 ...
	 */
	protected Document_original(String text)
	{
		this.text = text;
	}
	 ...
	 */
	public static boolean testCase(Document_original doc, int syllables, int words, int sentences)
	{
