 ...
 */
public class EfficientDocument_original extends Document {
	...
	public EfficientDocument_original(String text)
	{
		super(text);
		processText();
	}
	...
	{
	    testCase(new EfficientDocument_original("This is a test.  How many???  "
                + "Senteeeeeeeeeences are here... there should be 5!  Right?"),
                16, 13, 5);
        testCase(new EfficientDocument_original(""), 0, 0, 0);
        testCase(new EfficientDocument_original("sentence, with, lots, of, commas.!  "
                + "(And some poaren)).  The output is: 7.5."), 15, 11, 4);
        testCase(new EfficientDocument_original("many???  Senteeeeeeeeeences are"), 6, 3, 2); 
        testCase(new EfficientDocument_original("Here is a series of test sentences. Your program should "
				+ "find 3 sentences, 33 words, and 49 syllables. Not every word will have "
				+ "the correct amount of syllables (example, for example), "
				+ "but most of them will."), 49, 33, 3);
		testCase(new EfficientDocument_original("Segue"), 2, 1, 1);
		testCase(new EfficientDocument_original("Sentence"), 2, 1, 1);
		testCase(new EfficientDocument_original("Sentences?!"), 3, 1, 1);
		testCase(new EfficientDocument_original("Lorem ipsum dolor sit amet, qui ex choro quodsi moderatius, nam dolores explicari forensibus ad."),
		         32, 15, 1);
