 ...
 */
public class BasicDocument_original extends Document 
{
	/** Create a new BasicDocument object
	 * 
	 * @param text The full text of the Document.
	 */
	public BasicDocument_original(String text)
	{
		super(text);
	}
	...
	public static void main(String[] args)
	{
		 ...
		 */
		testCase(new BasicDocument_original("This is a test.  How many???  "
		        + "Senteeeeeeeeeences are here... there should be 5!  Right?"),
				16, 13, 5);
		testCase(new BasicDocument_original(""), 0, 0, 0);
		testCase(new BasicDocument_original("sentence, with, lots, of, commas.!  "
		        + "(And some poaren)).  The output is: 7.5."), 15, 11, 4);
		testCase(new BasicDocument_original("many???  Senteeeeeeeeeences are"), 6, 3, 2);
		testCase(new BasicDocument_original("Here is a series of test sentences. Your program should "
				+ "find 3 sentences, 33 words, and 49 syllables. Not every word will have "
				+ "the correct amount of syllables (example, for example), "
				+ "but most of them will."), 49, 33, 3);
		testCase(new BasicDocument_original("Segue"), 2, 1, 1);
		testCase(new BasicDocument_original("Sentence"), 2, 1, 1);
		testCase(new BasicDocument_original("Sentences?!"), 3, 1, 1);
		testCase(new BasicDocument_original("Lorem ipsum dolor sit amet, qui ex choro quodsi moderatius, nam dolores explicari forensibus ad."),
		         32, 15, 1);
	}
