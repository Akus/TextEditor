 ...
 *
 */
public class NearbyWords_compl implements SpellingSuggest {
    private static final int THRESHOLD = 1000; 
	
	Dictionary dict;
   
   public NearbyWords_compl (Dictionary dict) {
      this.dict = dict;
   }
   ...
   public void deletions(String s, List<String> currentList, boolean wordsOnly) {
	...
	public List<String> suggestions(String word, int numSuggestions) {
		...
		// words nearbyfor(int index = 0; index < s.length(); index++){
		for(int charCode = (int)'a'; charCode <= (int)'z'; charCode++) {
   ...
   public static void main(String[] args) {
	   String word = "i";
	   NearbyWords_compl w = new NearbyWords_compl (new DictionaryHashSet("Course2/data/dict.txt"));
