 ...
 *
 */
class TrieNode_original {
	private HashMap<Character, TrieNode_original> children; 
	private String text;  // Maybe omit for space
	private boolean isWord;
	
	/** Create a new TrieNode */
	public TrieNode_original()
	{
		children = new HashMap<Character, TrieNode_original>();
		text = "";
		isWord = false;
	}
	
	/** Create a new TrieNode given a text String to store in it */
	public TrieNode_original(String text)
	{
		this();
		this.text = text;
	}
	 ...
	 *   is not in the trie.
	 */
	public TrieNode_original getChild(Character c)
	{
	 ...
	 *     in the trie.
	 */
	public TrieNode_original insert(Character c)
	{
		if (children.containsKey(c)) {
			return null;
		}
		
		TrieNode_original next = new TrieNode_original(text + c.toString());
		children.put(c, next);
		return next;
	}
